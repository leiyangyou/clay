...
// --- DOM refs ---
  ...
  // --- DM Mode (delegated to app-dm.js) ---
  function openDm(targetUserId) { _dmOpenDm(targetUserId); }
  ...
  function showDmTypingIndicator(typing) { _dmShowDmTypingIndicator(typing); }
  function handleDmSend() { return _dmHandleDmSend(); }
